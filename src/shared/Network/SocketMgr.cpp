...
bool SocketMgr::StartNetwork(boost::asio::io_service& service, std::string const& bindIp, uint16 port)
{
	_threadCount = 1;//sConfigMgr->GetIntDefault("Network.Threads", 1);
